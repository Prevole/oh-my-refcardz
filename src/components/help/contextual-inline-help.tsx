  ...
  sheet: {
    ...
    "layout-navigation": {
      tokens: [
        ...
        { kind: "key", actionId: ACTION_IDS.LAYOUT_NAV_TO_MOVE },
        { kind: "text", text: ", resize with" },
        { kind: "key", actionId: ACTION_IDS.LAYOUT_NAV_TO_RESIZE },
    ...
    "layout-move": {
      tokens: [
        ...
        { kind: "key", actionId: ACTION_IDS.LAYOUT_MOVE_TO_NAV },
        { kind: "text", text: ", resize with" },
        { kind: "key", actionId: ACTION_IDS.LAYOUT_MOVE_TO_RESIZE },
        { kind: "text", text: "." },
      ],
    },
    "layout-resize": {
      tokens: [
        ...
        { kind: "text", text: ", back to nav with" },
        { kind: "key", actionId: ACTION_IDS.LAYOUT_RESIZE_TO_NAV },
        { kind: "text", text: ", move with" },
        { kind: "key", actionId: ACTION_IDS.LAYOUT_RESIZE_TO_MOVE },
        { kind: "text", text: "." },
      ],
    },
    dev: {
